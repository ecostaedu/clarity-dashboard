...
const initial = [
  { id: "1", name: "Individual", description: "Atendimento individual", active: true },
  { id: "2", name: "Grupal", description: "Dinâmica em grupo", active: true },
  { id: "3", name: "Familiar", description: "Atendimento com família", active: false },
];
...
export default function TiposAtendimentoPage() {
  ...
  return (
    <DashboardLayout breadcrumbs={[{ label: "Home" }, { label: "Social / Psicóloga" }, { label: "Tipos de Atendimento" }]}>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div><h1 className="text-2xl font-bold text-foreground">Tipos de Atendimento</h1><p className="text-sm text-muted-foreground">{data.length} tipos.</p></div>
      ...
      <FormModal open={modal} onClose={() => { setModal(false); setEditing(null); }} title={editing ? "Editar" : "Novo Tipo"} onSave={handleSave}>
