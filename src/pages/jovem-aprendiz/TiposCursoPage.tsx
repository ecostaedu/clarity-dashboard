...
const mockData = [
  { id: "1", nome: "Administração", descricao: "Curso de administração", ativo: true },
  { id: "2", nome: "Tecnologia da Informação", descricao: "Curso de TI", ativo: true },
  { id: "3", nome: "Logística", descricao: "Curso de logística", ativo: false },
];
...
export default function TiposCursoPage() {
  ...
  return (
    <DashboardLayout breadcrumbs={[{ label: "Home" }, { label: "Jovem Aprendiz" }, { label: "Tipos de Curso" }]}>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div><h1 className="text-2xl font-bold text-foreground">Tipos de Curso</h1><p className="text-sm text-muted-foreground mt-1">{data.length} tipos.</p></div>
      ...
      <FormModal open={modalOpen} onClose={() => { setModalOpen(false); setEditId(null); }} title={editId ? "Editar" : "Novo Tipo de Curso"} onSave={handleSave}>
